...
public class GetRequest<T> extends Request<T> {
     ...
     */
    public GetRequest(String url, Class<T> theClass, Map<String, String> headers,
    ...
    public GetRequest(String url, Class<T> theClass, Map<String, String> headers, Map<String, String> params,
                      Listener<T> listener, ErrorListener errorListener) {
